<table class="table" style="margin-top: 10px">
    ...
    <tbody>
    <tr>
        <td>AWS sns package</td>
        <td>February 26, 2024</td>
        <td>Detailed description of the API of the AWS sns package.</td>
    </tr>
    </tbody>
</table>
...
The Javascript API of the awssns package has two pieces:

- **HTTP requests**
- **Flow steps**

## HTTP requests
You can make `GET` requests to the [awssns API](https://docs.aws.amazon.com/sns/latest/api/welcome.html) like this:
```javascript
var response = app.endpoints.awssns.get('/?Action=ListSubscriptions&Version=2010-03-31&AUTHPARAMS')
